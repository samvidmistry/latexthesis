...
\newcommand{\HRule}{\rule{\linewidth}{0.2mm}} % New command to make the lines in the title page
...
{\Large \href{\authemail}{\textbf{\authornames}}} \\
{\Large \textbf{\rollno}}
...
\begin{figure}[hb]
  \centering
  \includegraphics[width=0.35\linewidth]{blacklogo}
\end{figure}

\large \textit{to the}

{\Large \textbf{\deptname}}\\ % Research group name and department name
{\Large \textsc{ \univname}}\\[1.5cm] % University name
\large \today\\[2cm] % Date
